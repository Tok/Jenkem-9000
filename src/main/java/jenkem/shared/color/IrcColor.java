...
public enum IrcColor {
    ...
    white(0,      new int[] {255, 255, 255}, false, new int[] {100,  90, 100, 100,  10, 100, 100}),
    black(1,      new int[] {0,     0,   0},  true, new int[] {100,  90, 100, 100,  10, 100, 100}),
    darkBlue(2,   new int[] {0,     0, 127},  true, new int[] {100,  66,  70,   0,  75,   0,   0}),
    darkGreen(3,  new int[] {0,   147,   0},  true, new int[] {100,  71,  75,   0,  75,   0,   0}),
    red(4,        new int[] {255,   0,   0},  true, new int[] {100,  95, 100, 100, 100,   0,   0}),
