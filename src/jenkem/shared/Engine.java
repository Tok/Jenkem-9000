...
public class Engine {
	 ...
	 * @return Strings for IRC.
	 */
	public void generateSuperHybrid(final ImageData id, final ColorScheme scheme, final CharacterSet preset, final double contrast, final int brightness, final String kick) {
		this.colorMap = prepareColorMap(scheme);
		this.id = id;
		this.preset = preset;
		this.contrast = contrast;
	 ...
	 * @return Strings for IRC.
	 */
	public void generateHybrid(final ImageData id, final ColorScheme scheme, final CharacterSet preset, final double contrast, final int brightness, final String kick) {
		this.colorMap = prepareColorMap(scheme);
		this.id = id;
		this.preset = preset;
		this.contrast = contrast;
	 ...
	 * @param ImageData id
	 */
	public void generatePwntari(final ImageData id, final ColorScheme scheme, final CharacterSet preset, final double contrast, final int brightness, final String kick) {
		this.colorMap = prepareColorMap(scheme);
		this.id = id;
		this.preset = preset;
		this.contrast = contrast;
	 ...
	 * @return Strings for IRC.
	 */
	public void generatePlain(final ImageData id, final CharacterSet preset, final double contrast, final int brightness, final String kick) {
		this.id = id;
		this.preset = preset;
		this.contrast = contrast;
		this.brightness = brightness;
	...
	public String[] removeEmptyLines(String[] input) {
		...
		for (String line : input) {
			if (line != null && !line.equals("")) {
//				//omit last line if Y is not kicked
//				if (startY == 0 && index == result.length -1) {
//					//ignore
//				} else {					
					result[index] = line;
//				}
